...
import com.oinyougou.seckill.service.SeckillGoodsService;
...
public class SeckillGoodsServiceImpl implements SeckillGoodsService {
    ...
    public List<TbSeckillGoods> findList() {
        ...
        if (list==null||list.size()==0){
            ...
            for (TbSeckillGoods tbSeckillGood : list) {

                redisTemplate.boundHashOps("seckillGoods").put(tbSeckillGood.getId(),tbSeckillGood);//将商品存入缓存
            }
